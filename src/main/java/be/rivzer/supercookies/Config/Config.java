package be.rivzer.supercookies.Config;
...
public class Config {
    ...
    public static void saveConfig1() {
        File file = new File("plugins//SuperCookies//config.yml");
        try {
    ...
    public static void saveConfig2() {
        File file = new File("plugins//SuperCookies//data.yml");
        try {
    ...
    public static void saveConfig3() {
        File file = new File("plugins//SuperCookies//language.yml");
        try {
            Config.getCustomConfig3().save(file);
        } catch (IOException ee) {
            ee.printStackTrace();
        }
    }
